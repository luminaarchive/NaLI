...
export default function PublicationDetailPage({ params }: { params: Params }) {
  ...
  return (
    <article className="bg-paper min-h-screen">
      ...
      {/* Navigation header */}
      <div className="mx-auto w-full max-w-[1480px] px-5 sm:px-8 pt-8 pb-4">
        <Link href="/jurnal" className="font-mono text-xs uppercase tracking-wider text-ink/70 hover:text-ink hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink">
          ← Katalog jurnal
        </Link>
      </div>
      ...
      <div className="mx-auto w-full max-w-[1480px] px-5 sm:px-8 py-8">
            ...
            <div className="w-[180px] sm:w-[200px] md:w-[220px] lg:w-[240px] aspect-[3/4] relative overflow-hidden border border-dashed border-ink/40 bg-ink-wash/5 shadow-md">
              {coverImage ? (
                ...
                <div className="w-full h-full flex flex-col justify-center text-center p-4 bg-ink-wash/10" data-jurnal-cover-fallback="true">
                  ...
                  <p className="mt-3 font-mono text-[0.55rem] text-ink/40">
        ...
        <div className="text-center max-w-4xl mx-auto mb-5">
          ...
          {pub.originalTitle && pub.originalTitle !== pub.title && (
            <p className="mt-2 font-mono text-[0.8rem] text-ink/65 leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 mb-4">
          {pub.peerReviewed && (
            <span className="border border-green-700/60 bg-green-50/50 text-green-800 dark:border-green-400/30 dark:bg-green-950/20 dark:text-green-300 px-2.5 py-0.5 font-mono text-[0.6rem] font-bold uppercase tracking-wider">
              Peer Reviewed
            </span>
          )}
