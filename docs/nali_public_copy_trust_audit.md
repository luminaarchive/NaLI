...
```
grep -RniE "seed|contoh|dummy|placeholder|ilustratif|observasi kami|kami melihat|
  kami menemukan|kami mengamati|dari lokasi sebenarnya|catatan lapangan dari lokasi" .
```
...
| 2 field notes: `> _Catatan lapangan contoh (seed). Bersifat ilustratif._` | Public content | **Removed**; notes rewritten as third-party research notes |
...
| `app/page.tsx`: "Catatan lapangan dari lokasi sebenarnya" | Public UI | **Reframed** → "Catatan riset dari laporan & observasi pihak ketiga" |
| `app/page.tsx`, FAQ + Arsip callout: "Terbit harian" | Public UI | **Softened** → "Menuju publikasi rutin" / "Setiap klaim bersumber" |
...
- Before: _"Catatan lapangan contoh (seed). Bersifat ilustratif."_ + _"Pendakian dimulai jauh sebelum subuh…"_ (first-person field).
- After: _"Catatan riset terbuka. Disusun dari laporan peneliti, reportase, dan dokumentasi lapangan pihak ketiga — bukan klaim observasi pribadi NaLI."_ + third-person synthesis ("Laporan dan dokumentasi pihak ketiga secara konsisten menyebut…").
...
- Before: _"Field journal & research publication berbasis AI…"_
...
## Catatan Lapangan reframe (Phase 3)
