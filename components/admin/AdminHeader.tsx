...
export function AdminHeader({ active }: { active?: "posts" | "analytics" }) {
  return (
      ...
      <div className="container-editorial flex h-16 items-center justify-between">
        <div className="flex items-baseline gap-5">
          ...
          <nav className="flex gap-4">
            <Link
              href="/admin"
              className={`font-mono text-[0.72rem] uppercase tracking-[0.16em] ${active === "posts" ? "text-ink underline underline-offset-4" : "text-gray hover:text-ink"}`}
            >
              Tulisan
            </Link>
            <Link
