    ...
    return NextResponse.json(
      {
        ...
        answer_verification,
        journal_readiness,
        journal_candidate: "journal_candidate" in report ? report.journal_candidate : undefined,
        journal_quality: "journal_quality" in report ? report.journal_quality : undefined,
        report,
      },
      { headers, status: 200 },
    );
