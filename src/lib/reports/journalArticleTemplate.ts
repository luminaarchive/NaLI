...
import { PUBLIC_REPORT_DISCLAIMER, SOURCE_VERIFICATION_MVP_STATUS } from "./reportGenerator";
...
const profiles: Record<string, ArticleProfile> = {
  peregrine: {
    ...
    literatureReview: paragraphs(
      "Tidak ada buku, artikel jurnal, kunci identifikasi, atau sumber daring yang diserahkan bersama catatan pengamatan. Dengan demikian, bagian ini bukan ringkasan pustaka yang sudah diverifikasi. Source verification belum aktif di MVP ini. NaLI tidak membuat kutipan atau daftar rujukan untuk mengisi kekosongan tersebut.",
    ...
    conclusion:
      "Dua catatan pengguna menunjukkan perbedaan deskriptif pada bentuk, tepi, dan warna tampak daun. Draft ini menyediakan struktur artikel praktikum yang lengkap untuk mengelola hasil tersebut sekaligus menandai bukti yang belum ada. Kesimpulan hanya berlaku pada karakter yang dicatat; dokumentasi, pengukuran, pengulangan, dan rujukan terverifikasi tetap diperlukan sebelum analisis diperluas.",
  },
  obsidian: {
    abstract: paragraphs(
    ...
    literatureReview: paragraphs(
      "Tidak ada referensi yang diserahkan pengguna dan Source verification belum aktif di MVP ini. Karena itu, bagian tinjauan ini tidak menyatakan telah menelaah karya tertentu serta tidak menambahkan nama penulis, tahun, DOI, atau penerbit. Pernyataan konseptual berikut berfungsi sebagai peta kebutuhan pustaka, bukan hasil verifikasi bibliografis.",
    ...
    conclusion:
      "Satu-satunya hasil yang dapat dipertahankan adalah bahwa catatan pengguna melaporkan perbedaan bentuk, tepi, dan warna tampak antara objek Daun A dan Daun B. Artikel ini menyusun batas klaim, tabel audit, dan kebutuhan bukti untuk melanjutkan pengamatan secara lebih tertib. Tidak ada identifikasi, sumber terverifikasi, atau kesimpulan biologis lanjutan yang dapat diberikan dari bahan saat ini.",
  },
  zephyr: {
    abstract: paragraphs(
    ...
    literatureReview: paragraphs(
      "Naskah ini belum disertai sumber pustaka yang dipilih pengguna. Source verification belum aktif di MVP ini, sehingga NaLI tidak menyisipkan referensi yang tampak meyakinkan namun tidak dapat dilacak. Bagian literatur dibangun sebagai arah pembacaan yang diperlukan untuk mengubah catatan awal menjadi pembahasan yang bertumpu pada sumber nyata.",
    ...
    conclusion:
      "Catatan pengguna memberi dasar yang jujur untuk menyatakan bahwa Daun A dan Daun B dilaporkan berbeda dalam bentuk, tepi, dan warna tampak. Artikel ini memperhalus catatan tersebut menjadi draft jurnal yang tertata, namun tetap menjaga ruang antara deskripsi dan kesimpulan yang belum dapat dibuktikan. Foto, pengukuran, ulangan, serta pustaka yang diperiksa merupakan langkah penting untuk pengembangan berikutnya.",
  },
};
...
export function buildJournalArticle(input: JournalBuildInput, modelId: string): JournalArticle {
  ...
  return {
    cover: {
      ...
      seriesTitle: "Founder/Admin QA Draft Series",
      issueLine: "CP1 Internal QA Edition",
      year,
      coverSubtitle: "Draft Artikel Observasi Morfologi Daun",
      brandNote: "Prepared by NaLI — Native Field Intelligence Services",
      truthNote: "Internal QA draft; not a published journal article. draft bantuan belajar/penulisan berbasis bukti.",
    },
    metadata: {
      ...
      affiliation: "NaLI CP1 Founder/Admin QA",
    },
    infoBlock: {
      received: "Not applicable",
      accepted: "Not applicable",
      published: "Not published",
      evidenceStatus: "user-provided notes only",
      verificationStatus: "Unverified",
      exportStatus: "Locked - founder/admin local QA only",
    },
    abstract: {
    ...
    evidence: {
      figureCaption: "Figure 1. Visual documentation slot — photo not provided.",
      photoSlot: "Foto belum disediakan. Slot disiapkan untuk dokumentasi pengguna yang diberi label.",
      ...
      referenceSlot: SOURCE_VERIFICATION_MVP_STATUS,
    },
