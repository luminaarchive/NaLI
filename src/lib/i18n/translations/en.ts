export const en = {
  ...
  auth: {
    ...
    signInTitle: "Sign in to NaLI workspace",
    signInContext: "Access reports, local/account notes, and evidence-based work history.",
    email: "Email",
    password: "Password",
    ...
    role: "Role",
    roles: {
      ranger: "Ranger / Field Team",
      rangerDescription: "Field observations, encountered species, and report draft documentation.",
      researcher: "Researcher",
      researcherDescription: "Research report framework composition and scientific evidence mapping.",
      student: "Student",
      studentDescription: "Guided reports for biology/ecology practicums, field studies, and learning.",
      umum: "General Public",
      umumDescription: "Report drafting for citizen science, nature enthusiasts, and general public use.",
    },
  },
  observe: {
